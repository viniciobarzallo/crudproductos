...
a persistence unit "ExamenBarzalloVinicioServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenBarzalloVinicioServidor\pom.xml":
...
artifact ("ExamenBarzalloVinicioServidor.war") is already built. You can build
